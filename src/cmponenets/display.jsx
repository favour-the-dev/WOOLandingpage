        ...
        <>
            <div className="flex flex-col lg:flex-row items-center gap-8 p-4 w-full mt-4">
                <div  className={`w-full md:w-2/3 lg:w-1/2 flex flex-col gap-2 ${props.order1}`} id="text-box">
                    ...
                    <p className="text-md text-gray-600 mb-2">{props.body}</p>
                    <button className="text-gray-100 w-2/3 uppercase rounded-full p-2 text-xs lg:text-sm bg-text-custom shadow-md">{props.btntext}</button>
                </div>
