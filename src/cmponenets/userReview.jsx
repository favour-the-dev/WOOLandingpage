const Users = ()=>{
    ...
    const url = 'https://picsum.photos/200?grayscale&blur=2'
    const url2 = 'https://picsum.photos/200?grayscale&blur=2'
    return(
        <>
            <div className="bg-text-custom w-full h-100dvh p-4">
                <div className="w-full lg:w-2/3 mx-auto flex flex-col gap-6 items-center justify-between h-full">
                    ...
                    <div className="text-gray-200 flex flex-col lg:flex-row items-center gap-4">
                        ...
                        <img src={url2} alt="" className="rounded-full order-one "/>
                    </div>
                </div>
            </div>
        </>
